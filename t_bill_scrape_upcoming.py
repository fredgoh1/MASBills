...
from t_bill_scraper import CSV_PATH, AUCTION_URL, create_driver, convert_date, scrape_cutoff_yield


def main():
    parser = argparse.ArgumentParser(
        description="Scrape Cut-off Yield for upcoming/open T-Bills up to a given date."
    )
    parser.add_argument(
        "date",
        help="Cutoff date in yyyy-mm-dd format. T-Bills with Auction Date on or before this date will be scraped.",
    )
